...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Check if user still exists (handles admin deletion)
    axiosInstance.get(API_PATHS.AUTH.GET_PROFILE).catch(() => {});
    getDashboardData();
    return () => {};
  }, []);
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-4 md:my-6">
      <div>
        <div className="card">
          ...
          <CustomPieChart data = {pieChartData} colors = {COLORS}></CustomPieChart>
        </div>
      </div>
